 ...
 * «1500,50» guardaba 150050, cien veces de más, sin ningún aviso. El error no se veía al
 * escribirlo; se veía después, en el saldo.
 *
 ...
 *
 * No hace falta saber la configuración regional del teléfono ni adivinar: la posición
 * del último separador ya lo dice. Un separador suelto al final («1500,») se acepta
 * mientras se escribe, porque si no el campo se pelearía con el dedo.
 */
