...
export const NAV: NavGroup[] = [
  {
    label: "Resumen",
    items: [{ id: "dashboard", name: "Panel", icon: "dashboard", href: "/dashboard" }],
  },
  {
    label: "Perfil",
    items: [
  ...
  },
  {
    label: "Crecimiento",
    items: [
      { id: "wealth", name: "Patrimonio", icon: "invest", href: "/patrimonio" },
  ...
  },
  {
    label: "Patrimonio",
    items: [
      { id: "rich-life", name: "Mi Rich Life", icon: "networth", href: "/mi-rich-life" },
    ],
  },
];
...
export const BOTTOM_NAV: NavItem[] = [
  { id: "dashboard", name: "Panel", icon: "dashboard", href: "/dashboard" },
  { id: "base", name: "Base", icon: "budget", href: "/mi-base-financiera" },
  { id: "control", name: "Control", icon: "savings", href: "/control-financiero" },
  { id: "wealth", name: "Patrimonio", icon: "invest", href: "/patrimonio" },
  { id: "rich-life", name: "Rich Life", icon: "networth", href: "/mi-rich-life" },
];
