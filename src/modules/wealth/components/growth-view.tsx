      ...
      <section className="dash-hero">
        <div className="card card-pad" style={{ display: "flex", alignItems: "center", gap: 22 }}>
          ...
          <div>
            ...
            <div
              ...
              style={{
                marginTop: 8,
                background: "color-mix(in srgb," + ring + " 16%, transparent)",
                color: ring,
              }}
            >
        ...
        <div className="card card-pad">
          ...
          <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 14 }}>
            <BalanceBar
              label="Ofensiva (crecimiento)"
              value={balance.offense}
              color="var(--c-invest)"
            />
            <BalanceBar
              label="Defensiva (protección)"
              value={balance.defense}
              color="var(--c-protect)"
            />
          </div>
        ...
        <div className="card card-pad">
          ...
          >
            <div>
              ...
              <strong style={{ color: "var(--ink-2)" }}>
                {formatMoney(portfolio.monthlyContribution, currency)}
              </strong>
            </div>
            <div>
              Diversificación{" "}
              <strong style={{ color: "var(--ink-2)", textTransform: "capitalize" }}>
            ...
            <div>
              Concentración máx.{" "}
              <strong style={{ color: "var(--ink-2)" }}>
                {formatPercent(portfolio.topConcentration)}
              </strong>
            </div>
          </div>
          ...
          {buckets.size > 0 && (
            <div style={{ marginTop: 16, borderTop: "1px solid var(--line)", paddingTop: 12 }}>
              <div className="fld-label" style={{ marginBottom: 8 }}>
                Por categoría
              </div>
...
function HoldingRow({
  ...
  return (
    <div className="list-row" style={{ gridTemplateColumns: "1fr auto auto" }}>
      <div style={{ minWidth: 0 }}>
        <div style={{ fontSize: 13.5, fontWeight: 500 }}>{holding.label ?? holding.symbol}</div>
        <div
          className="muted"
          style={{
            fontSize: 11.5,
