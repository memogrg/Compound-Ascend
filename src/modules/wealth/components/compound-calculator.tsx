...
export function CompoundCalculator({
  ...
  const proj = useMemo(
    () => project(capital, monthly, rate, years),
  ...
  return (
    <div className="calc-grid">
        ...
        >
          ...
          <div className="row" style={{ gap: 8, alignItems: "center" }}>
            ...
            <button
              ...
              onClick={() => setCapital(Math.round(defaultCapital))}
              disabled={defaultCapital <= 0}
            >
              Usar mis datos
            </button>
          </div>
      ...
      <div className="card card-pad">
        ...
        >
          <div>
            <div className="label" style={{ fontSize: 11.5, color: "var(--muted)" }}>
              Valor final proyectado
            </div>
            <div className="num-xl" style={{ fontSize: 44, marginTop: 8 }}>
              {formatMoney(proj.finalValue, curr)}
            </div>
          </div>
        ...
        <div
          style={{ display: "flex", gap: 16, fontSize: 11.5, color: "var(--muted)", marginTop: 4 }}
        >
        ...
        <div className="calc-out">
          ...
          <div className="calc-stat">
            ...
            <div className="v" style={{ color: "var(--pos)" }}>
              {formatMoney(proj.interest, curr)}
            </div>
          </div>
          <div className="calc-stat">
        ...
        <p className="muted" style={{ fontSize: 11, marginTop: 12 }}>
          Proyección informativa · no es una recomendación de inversión. Total estimado en{" "}
          {formatCompact(proj.finalValue, curr)}.
        </p>
      </div>
    </div>
  );
...
function DualLine({ series, contrib }: { series: number[]; contrib: number[] }) {
  ...
  return (
    <svg
      ...
      style={{ width: "100%", height: 230, display: "block", marginTop: 14 }}
      aria-hidden
    >
      <defs>
