 ...
 * NOTA: el layer expone solo precio (Quote = price/currency/provider); el cambio
 * % del día y el mini-sparkline requieren extender los proveedores (follow-up).
 */
...
function MonitorRow({
  ...
  return (
    <div className="hold-row" style={{ gridTemplateColumns: "1fr auto auto", alignItems: "center" }}>
      ...
      <div className="hold-val">
        {loading ? (
          ...
          <>
            ...
            <div className="d muted">{quote.cached ? "caché" : "en vivo"}</div>
          </>
        ) : (
          <div className="muted" style={{ fontSize: 12 }}>
            sin precio
