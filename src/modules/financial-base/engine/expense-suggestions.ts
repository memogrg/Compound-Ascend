...
export const GROUP_SUGGESTIONS: Record<string, string[]> = {
  g_vivienda: ["Seguro de hogar", "Impuesto predial", "Cuota de administración / HOA", "Agua", "Electricidad", "Gas", "Internet y TV", "Muebles y hogar", "Limpieza", "Jardinería"],
  g_transporte: ["Combustible", "Seguro de auto", "Transporte público", "Parking y peajes", "Ride-share / taxi", "Lavado", "Revisión técnica", "Cuota del auto"],
  g_alimentacion: ["Café", "Delivery", "Comida en el trabajo", "Snacks y bebidas", "Mercado orgánico", "Carnicería / panadería"],
  g_salud: ["Seguro médico", "Dentista", "Óptica", "Terapia / psicólogo", "Suplementos", "Análisis y laboratorio", "Spa y masajes"],
  g_estilo: ["Hobbies", "Entretenimiento", "Ropa y calzado", "Regalos", "Mascotas", "Eventos y conciertos", "Salidas", "Cuidado del hogar"],
  g_educacion: ["Cursos online", "Libros", "Material de estudio", "Certificaciones", "Idiomas", "Colegiatura", "Talleres"],
};
