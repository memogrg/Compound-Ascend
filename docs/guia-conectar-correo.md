...
| **Scotiabank, Promerica, Davivienda, Lafise, Coopenae, Coopeservidores y los demás** | Perfil o Configuración → **Alertas** / **Notificaciones**                | el remitente aparece en cualquier aviso que ya tengas                      |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **BAC Credomatic**                                                                                                                                                                   | Compras con tarjeta (colones y dólares), SINPE recibido y enviado, comercio, fecha, referencia, últimos 4 de la tarjeta. Las compras **rechazadas** no se proponen.              | Propuesta completa; casi siempre solo hay que confirmar.                                                                                      |
| **BN, BCR, Popular, Scotiabank, Promerica, Davivienda, Lafise, Cathay, BCT, Improsa, Coopenae, Coopeservidores, Coopealianza, Coopeande, Mucap, Grupo Mutual, Caja de ANDE, Prival** | Lectura general: monto, moneda, si es gasto o ingreso, comercio o contraparte, fecha, referencia. Reconoce compras, SINPE Móvil, retiros en cajero, reversos y pagos de tarjeta. | Propuesta para **revisar**: dale una mirada antes de confirmar. A medida que llegan avisos reales de cada banco, la lectura se vuelve exacta. |
