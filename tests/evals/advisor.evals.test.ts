...
const SCENARIOS: Scenario[] = [
  ...
  {
    name: "tools: proyectar_inversion → reply contiene el valor_futuro real + 12 decls",
    ...
    assert: ({ result, provider }) => {
      ...
      expect(provider.lastTools).toHaveLength(12);
  ...
  {
    name: "tools: proyectar_libertad_financiera → reply con el Número real + 12 decls",
