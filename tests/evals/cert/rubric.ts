...
const JUDGE_SYSTEM = [
  ...
  "- accionabilidad: cierra con un paso concreto y CUANTIFICADO (₡ exacto + entidad, idealmente 1-tap).",
  '    "NA" SOLO si la consulta era puramente informativa o fuera de tema.',
